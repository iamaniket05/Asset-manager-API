...
router.post('/create', header.checkHeader,validator.designationCreate, token.verifyToken, designationController.create);
...
router.put('/update/:id', header.checkHeader,validator.designationUpdate, token.verifyToken, designationController.update);
